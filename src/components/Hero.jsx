...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        <div
          className={`flex ${styles.flexStart} flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mc-2`}
        >
      ...
      <div
        className={`flex-1 flex relative ${styles.flexCenter} md:my-0 my-10`}
      >
        <img
          src={robot}
          alt="robot"
        ...
        />
        <div className="absolute z-[0] pink__gradient w-[40%] h-[35%] top-0"></div>
